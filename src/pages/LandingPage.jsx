        ...
        <Container maxW="container.xl" py={4}>
          <Flex justify="space-between" align="center">
            ...
            <HStack spacing={8} display={{ base: "none", md: "flex" }}>
              <Link href="#" color="#0A2D5E" fontWeight="500" _hover={{ color: "#FDC800", textDecoration: "none" }}>
                Beranda
              </Link>
              <Link href="#daftar-ekskul" color="#0A2D5E" fontWeight="500" _hover={{ color: "#FDC800", textDecoration: "none" }}>
                Daftar Ekskul
              </Link>
        ...
        <Container maxW="container.xl">
          <SimpleGrid columns={{ base: 1, md: 3 }} spacing={10} mb={10}>
            <Box>
              ...
              <Text color="#c0d1e8">Mencetak generasi unggul & berkarakter.</Text>
            </Box>
            
            <Box>
              <Heading size="sm" color="#FDC800" mb={4}>Navigasi</Heading>
              <VStack align="start" spacing={2} color="#c0d1e8">
                <Link href="#">Beranda</Link>
                <Link href="#daftar-ekskul">Ekskul</Link>
              </VStack>
            </Box>

            <Box>
              <Heading size="sm" color="#FDC800" mb={4}>Kontak</Heading>
              <VStack align="start" spacing={2} color="#c0d1e8">
